...
3. Next, you will be asked to sign in. Use your normal computer login, username:  `firstnamelastname` for students and `firstname_lastname` for staff, and your district password
